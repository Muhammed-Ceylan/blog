                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="our_text_box">
                                    ...
                                    <div class="post_box padding_bottom1">
                                        ...
                                        <ul class="like">
                                            <li><a href="#"><img src="images/like.png" alt="#" />Like</a>
                                            </li>
                                            <li><a href="#"><img src="images/comm.png"
                                                        alt="#" />Comment</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="our_img">
                                    ...
                                    <div class="our_text_box position_box">
                                        ...
                                        <p class="hiuouh">There are many variations of passages of Lorem Ipsum
                                            ...
                                            Lorem Ipsum generators on the Internet tend to repea</p>
                                        <div class="post_box">
                                            <h4 class="flot_left1 withi_color">Post By : Blogger </h4>
                                            <ul class="like withi_color">
                                                <li><a href="#"><img src="images/like1.png"
                                                            alt="#" />Like</a></li>
                                                <li><a href="#"><img src="images/comm1.png"
                                                            alt="#" />Comment</a></li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 padding_bottom2">
                    ...
                    <div class="our_text_box three_box">
                        ...
                        <p>ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                            et dolore magna aliqua. Ut enim ad minimquis nostrud exercitation ullamco laboris </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="our_img">
